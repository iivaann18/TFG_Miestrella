...
async function createAdmin() {
    try {
        ...
        await pool.query(`INSERT INTO users (email, password, firstName, lastName, role) 
       VALUES (?, ?, ?, ?, 'admin')
       ON DUPLICATE KEY UPDATE password = VALUES(password)`, [adminEmail, hashedPassword, 'Admin', 'Mi Estrella']);
