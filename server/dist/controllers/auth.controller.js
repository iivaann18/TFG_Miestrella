...
export const register = async (req, res) => {
    try {
       ...
       VALUES (?, ?, ?, ?, ?, ?, 'customer')`, [email, hashedPassword, firstName, lastName, phone || null, gender || null]);
...
export const getProfile = async (req, res) => {
    try {
        ...
        const [users] = await pool.query(`SELECT id, email, firstName, lastName, phone, gender, role, permissions
...
export const updateProfile = async (req, res) => {
    try {
       ...
       WHERE id = ?`, [firstName, lastName, phone || null, gender || null, userId]);
...
export const changePassword = async (req, res) => {
    try {
        ...
        await pool.query('UPDATE users SET password = ?, updatedAt = NOW() WHERE id = ?', [hashedPassword, userId]);
...
export const createEmployee = async (req, res) => {
    try {
       ...
       VALUES (?, ?, ?, ?, 'employee', ?)`, [email, hashedPassword, firstName, lastName, JSON.stringify(permissions || {})]);
